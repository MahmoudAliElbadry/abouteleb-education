...
- [x] 1. Replace hash routing and establish SPA fallback deployment configuration.
...
- [x] 2. Repair public navigation, locale coverage, catalog search, and route-level failure states.
...
- [x] 3. Consolidate application flow and enforce consent behavior.
...
- [x] 4. Add protected client order tracking.
...
- [x] 5. Harden login and sensitive routes; remove credential exposure.
...
- [x] 6. Complete admin order filter/query support at the API boundary.
...
- [x] 7. Complete admin order filtering and resilient UI states.
...
- [x] 8. Verify the Phase 5.2 remediation release candidate.
...
- [x] 9. Add Phase 6 Prisma models, migration, indexes, and deterministic seed data.
...
- [x] 10. Define Phase 6 shared contracts and presenters.
...
- [x] 11. Implement university public/admin API with archival-safe behavior.
...
- [x] 12. Implement testimonial API with publication consent guard.
...
- [x] 13. Implement social-link and fixed contact-content APIs.
...
- [x] 14. Build the admin content shell and university management UI.
...
- [x] 15. Build testimonial, social-link, and contact management UI.
...
- [x] 16. Replace the static public university catalog with managed API data.
...
- [x] 17. Render managed testimonials, contact details, and social links publicly.
...
- [x] 18. Complete Phase 6 integration, regression, and staging validation.
...
- [x] **F1 Plan compliance audit:** Compare implemented paths and commits to Todos 1–18; reject any omitted acceptance criterion or unplanned CMS/upload/order-university work. Evidence: `docs/phase-06-final-plan-compliance.md`.
- [x] **F2 Code quality/security review:** Run root quality gates; inspect auth/CSRF/rate-limit, authorization, URL validation, secret handling, and audit behavior. Evidence: `docs/phase-06-final-quality-security.md`.
- [x] **F3 Real agent-executed QA:** Use staging browser/API flows for public deep links, client isolation, admin content CRUD, consent gating, archive visibility, and locale switching. Evidence: `docs/phase-06-final-staging-qa.md`.
- [x] **F4 Scope fidelity review:** Confirm deployment prerequisites, migration/seed repeatability, no manual intervention claims, and no forbidden scope additions. Evidence: `docs/phase-06-final-scope-fidelity.md`.
